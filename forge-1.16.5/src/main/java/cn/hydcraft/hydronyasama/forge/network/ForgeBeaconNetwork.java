...
public final class ForgeBeaconNetwork {
  ...
  private static final String HANDLER_NAME = "hydroline-HydroNyaSama";
  ...
  public void onServerStarted(FMLServerStartedEvent event) {
    ...
    ProbeCommandRegistrar.register(event.getServer());
    NgtCommandRegistrar.register(event.getServer());
    TrainCommandRegistrar.register(event.getServer());
        ...
        .execute(
            () -> {
              ...
              if (pipeline.get(HANDLER_NAME) == null) {
                pipeline.addBefore(
                    "packet_handler", HANDLER_NAME, new PluginPayloadInboundHandler(playerId));
              }
            });
  }
  ...
  private final class PluginPayloadInboundHandler
      extends SimpleChannelInboundHandler<ServerboundCustomPayloadPacket> {
    ...
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, ServerboundCustomPayloadPacket packet)
        throws Exception {
