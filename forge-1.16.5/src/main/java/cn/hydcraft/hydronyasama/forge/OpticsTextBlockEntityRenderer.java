...
final class OpticsTextBlockEntityRenderer extends BlockEntityRenderer<OpticsTextBlockEntity> {
  OpticsTextBlockEntityRenderer(BlockEntityRenderDispatcher dispatcher) {
    super(dispatcher);
  }
