...
/**
 * Immutable DTO definitions describing MTR data snapshots so loader-specific implementations can
 * map Minecraft/MTR objects into protocol-friendly representations without leaking Minecraft
 * classes into the common module.
 */
public final class MtrModels {
  ...
  public static final class FareAreaInfo {
    ...
    public FareAreaInfo(
        long stationId, String name, int zone, Bounds bounds, List<Long> interchangeRouteIds) {
      this.stationId = stationId;
      this.name = name;
      this.zone = zone;
      this.bounds = bounds;
  ...
  public static final class StationInfo {
    ...
    public StationInfo(
        ...
        Bounds bounds,
        List<Long> interchangeRouteIds,
        List<StationPlatformInfo> platforms) {
      this.dimensionId = Objects.requireNonNull(dimensionId, "dimensionId");
      this.stationId = stationId;
  ...
  public static final class StationPlatformInfo {
    ...
    public StationPlatformInfo(
        long platformId, String platformName, List<Long> routeIds, Long depotId) {
      this.platformId = platformId;
