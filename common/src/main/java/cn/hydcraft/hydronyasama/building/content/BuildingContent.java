...
public final class BuildingContent {
    ...
    public static void register(ContentRegistrar registrar) {
        registerCube(registrar, "anti_static_floor", "rock", "anti_static_floor");
        registerCube(registrar, "asphalt", "rock", "asphalt");
        registerCube(registrar, "black_marble", "rock", "black_marble");
