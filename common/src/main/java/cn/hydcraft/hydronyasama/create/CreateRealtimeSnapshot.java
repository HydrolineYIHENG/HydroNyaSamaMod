...
public final class CreateRealtimeSnapshot {
  private static final CreateRealtimeSnapshot EMPTY =
      new CreateRealtimeSnapshot(
          0L, Collections.<TrainStatus>emptyList(), Collections.<GroupStatus>emptyList());

  private final long capturedAt;
  private final List<TrainStatus> trains;
  private final List<GroupStatus> groups;

  public CreateRealtimeSnapshot(
      long capturedAt, List<TrainStatus> trains, List<GroupStatus> groups) {
  ...
  public static final class CarriageInfo {
    ...
    public CarriageInfo(
        int id,
        int bogeySpacing,
        TravellingPointInfo leading,
        TravellingPointInfo trailing,
        BogeyInfo leadingBogey,
        BogeyInfo trailingBogey) {
      this.id = id;
  ...
  public static final class GroupStatus {
    ...
    public GroupStatus(
        String groupId, String color, String reservedBoundaryId, List<String> trainIds) {
