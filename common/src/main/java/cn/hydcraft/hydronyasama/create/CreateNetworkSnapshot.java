...
public final class CreateNetworkSnapshot {
  ...
  public static final class SignalBoundaryInfo {
    ...
    public SignalBoundaryInfo(
        String boundaryId,
        String graphId,
        String edgeId,
        double position,
        String groupIdPrimary,
        String groupIdSecondary,
        String dimension,
        double x,
        double y,
        double z) {
  ...
  public static final class EdgeSegmentInfo {
    ...
    public EdgeSegmentInfo(
        String segmentId, String edgeId, double startPos, double endPos, String groupId) {
