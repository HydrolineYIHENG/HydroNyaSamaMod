...
final class CombinedObjUnbakedModel116 implements UnbakedModel {
  private final List<UnbakedModel> delegates;

  CombinedObjUnbakedModel116(List<UnbakedModel> delegates) {
  ...
  public @Nullable BakedModel bake(
    ...
    return new CombinedObjBakedModel116(baked);
  }
}
